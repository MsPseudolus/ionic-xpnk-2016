...
$scope.twttModal = function(arg1,modaltype,tweet_oembed,twitter_user) {
  ...
  console.log("ARG1 IS A: " + typeof arg1);

  var charsRemain = 139 - twitter_user.length;
  ...
  $scope.contact = {
    ...
    info: modaltype,
    oembed: tweet_oembed,
    tweeter: twitter_user,
    charCount: charsRemain
  };

  if (modaltype == 'retweet') {
    $scope.modaltempl = 'templates/retweet-modal.html';
  }
  else if (modaltype == 'reply') {
    $scope.modaltempl = 'templates/twreply-modal.html';
  }
  else if (modaltype == 'like') {
    $scope.modaltempl = 'templates/twlike-modal.html';
  }
  else {
    $scope.modaltempl = 'templates/twlike-modal.html';
  }
